...
```
docker run --name=ingmapping/tilemill -p 20008:20008 -p 20009:20009 -d -t ingmapping/tilemill
```
...
```
docker run -d --name="ingmapping/tilemill" -p 20008:20008 -p 20009:20009 -v ~/Documents/MapBox/project/:/root/Documents/MapBox/project/ -t ingmapping/tilemill
```
